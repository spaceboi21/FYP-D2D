...
#         try:
#             r = requests.post(fastapi_ask_url, json=payload, stream=True, timeout=120)
...
#     return render_template('404.html', message="The requested page was not found. Please check if the FastAPI server is running on port 8001."), 404